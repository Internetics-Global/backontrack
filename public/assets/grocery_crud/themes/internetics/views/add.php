                    ...
                    <?php echo form_close(); ?>
                     ...
                     <div class="form-group gcrud-form-group">
                        <div class="col-sm-offset-3 col-sm-12">
							...
							<BR>
						    <input type="image" onclick="print_me();" class="print_pdf_button" id="print_pdf_button" style="display: inline-block;" src="../../../../public/assets/grocery_crud/themes/internetics/images/print-pdf-icon2.png" />
