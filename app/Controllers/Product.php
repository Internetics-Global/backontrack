...
//      $crud->fields(['title']);       
		...
		$crud->displayAs('conduct_physical_screen','Conduct Physical Screens to determine the client’s mobility level RIGHT NOW (as compared to their current care plan). Tick the tests that the client passes');
		$crud->displayAs('available_equipment_1','Level 1 Equipment Availability: Check the client’s mobility level determined by the Physical Screens. From the relevant category, consider which equipment is available'); 
		$crud->displayAs('available_equipment_1_other','Other equipment you have available');
		$crud->displayAs('available_equipment_2','Level 2 Equipment Availability: Check the client’s mobility level determined by the Physical Screens. From the relevant category, consider which equipment is available'); 
		$crud->displayAs('available_equipment_2_other','Other equipment you have available'); 
		$crud->displayAs('available_equipment_3','Level 3 Equipment Availability: Check the client’s mobility level determined by the Physical Screens. From the relevant category, consider which equipment is available'); 
		$crud->displayAs('available_equipment_3_other','Other equipment you have available'); 
		$crud->displayAs('available_equipment_4','Level 4 Equipment Availability: Check the client’s mobility level determined by the Physical Screens. From the relevant category, consider which equipment is available'); 
		$crud->displayAs('handling_procedure_1','Level 1: Check the client’s mobility level which may now be further modified by the equipment available. From the relevant category, tick the people handling procedures you intend to complete today'); 
		$crud->displayAs('handling_procedure_2','Level 2: Check the client’s mobility level which may now be further modified by the equipment available. From the relevant category, tick the people handling procedures you intend to complete today'); 
		$crud->displayAs('handling_procedure_3','Level 3: Check the client’s mobility level which may now be further modified by the equipment available. From the relevant category, tick the people handling procedures you intend to complete today'); 
		$crud->displayAs('handling_procedure_4','Level 4: Check the client’s mobility level which may now be further modified by the equipment available. From the relevant category, tick the people handling procedures you intend to complete today'); 
