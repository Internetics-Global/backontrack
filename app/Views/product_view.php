...
<body>
 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <a class="navbar-brand mx-auto" href="#">Functional Mobility Screening Tool</a>
...
//					textboxes = document.querySelectorAll('#questions input[type="text"]'); //select all textboxes
        ...
        /*            $('#final_mobility_level').css('display', 'block');    */
                    ...
                    if (( ($('#q13').css('display') == 'block' ) && (mobility_levels.innerHTML == 'You are at Level 1'  )  )) {  final_mobility_level.innerHTML = '1'; conclusion_mobility_level.innerHTML = 'Supervision'; $('#summary_view').css('display', 'block');}
                    if (( ($('#q13').css('display') == 'block' ) && (mobility_levels.innerHTML == 'You are at Level 2'  )  )) {  final_mobility_level.innerHTML = '2'; conclusion_mobility_level.innerHTML = 'Physical assisted ambulant person'; $('#summary_view').css('display', 'block');}
                    if (( ($('#q13').css('display') == 'block' ) && (mobility_levels.innerHTML == 'You are at Level 3'  )  )) {  final_mobility_level.innerHTML = '3'; conclusion_mobility_level.innerHTML = 'Standing lifter'; $('#summary_view').css('display', 'block');}
                    if (( ($('#q13').css('display') == 'block' ) && (mobility_levels.innerHTML == 'You are at Level 4'  )  )) {  final_mobility_level.innerHTML = '4'; conclusion_mobility_level.innerHTML = 'Full lifter'; $('#summary_view').css('display', 'block');}
		    ...
		    var a_single_checkbox = false;
				...
				for (var i = 0; i < cbTotal.length; i++) {
					...
					var question = i;checkbox = cbTotal[i].checked; checkbox_array.push(checkbox);   /* alert(checkbox_array[i]); */
						...
						if (cbTotal[i].checked == true){ a_single_checkbox = true; }
				
							if (!a_single_checkbox) { display_mobility_level.style.display = "none"; mobility_level_calc.innerHTML = 'Need all Level 1 Equipment'; }
				...
				for (var i = 0; i < cbTotal.length; i++) {
					...
					var question = i;checkbox = cbTotal[i].checked; checkbox_array.push(checkbox);  /* alert(checkbox_array[i]); */
						...
						if (cbTotal[i].checked == true){ a_single_checkbox = true; }
							...
							if (!a_single_checkbox) { display_mobility_level.style.display = "none"; mobility_level_calc.innerHTML = 'Need all Level 2 Equipment'; }
...
//  old logic for ALL checkboxes
//							if (!all_checkboxes) { display_mobility_level.style.display = "none"; mobility_level_calc.innerHTML = 'Need all Level 3 Equipment'; }	

// new logic for just ONE checkbox

						if (!a_single_checkbox) { display_mobility_level.style.display = "none"; mobility_level_calc.innerHTML = 'Need all Level 3 Equipment'; }	
				...
				for (var i = 0; i < cbTotal.length; i++) {
					...
					var question = i;checkbox = cbTotal[i].checked; checkbox_array.push(checkbox);  /* alert(checkbox_array[i]); */
						...
						if (cbTotal[i].checked == true){ a_single_checkbox = true; }
							...
							if (!a_single_checkbox) { display_mobility_level.style.display = "none"; mobility_level_calc.innerHTML = 'Need all Level 4 Equipment';  /** $('#next_question_btn').css('display', 'none'); **/ }	
